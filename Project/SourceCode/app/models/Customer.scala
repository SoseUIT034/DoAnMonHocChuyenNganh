...
/**
  ...
  */
case class Customer (id: Int, name: String, email: String, phone: Long, username: String, password: String, addressId: Int)

case class CustomerFormData(name: String, email: String, phone: Long, username: String, password: String, address: Int)
